...
<nav class="uk-navbar-container uk-navbar-transparent uk-overlay-default" uk-navbar uk-sticky>
    <div class="uk-navbar-left">
        <a class="uk-navbar-item uk-logo" href="{{route('writer.mypage')}}">
            @component('cell.logo')
            @endcomponent
        </a>
        ライターページ
    ...
    <div class="uk-navbar-right">
        @guest
            <div class="uk-navbar-item uk-visible@s">
                <a class="uk-button uk-button-primary" href="{{ route('writer.login') }}">
                    ログイン
                </a>
            </div>
        @else
            <div class="uk-navbar-item uk-visible@s">
                <a class="uk-button uk-button-primary" href="{{ route('writer.mypage') }}">
                    ライターページ
                </a>
                <a class="uk-button uk-button-default" href="{{ route('writer.logout') }}">
                    ログアウト
                </a>
            </div>
        @endguest
...
<div id="menu-offcanvas" uk-offcanvas="overlay: true;flip: true;">
    <div class="uk-offcanvas-bar">
        @guest
            <div class="uk-margin">
                <div class="uk-margin-small">
                    <a class="uk-button uk-button-text uk-width-1-1" href="{{ route('writer.login') }}">
                        ログイン
                    </a>
                </div>
            </div>
        @else
            <div class="uk-margin">
                <div class="uk-margin-small">
                    <a class="uk-button uk-button-default uk-width-1-1" href="{{ route('writer.mypage') }}">
                        ライターページ
                    </a>
                </div>
                <div class="uk-margin-small">
                    <a class="uk-button uk-button-text uk-width-1-1" href="{{ route('writer.logout') }}">
                        ログアウト
                    </a>
                </div>
            </div>
