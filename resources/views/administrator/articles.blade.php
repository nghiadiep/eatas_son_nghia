...
<div class="uk-margin">
    ...
    <a class="uk-margin-left uk-button uk-button-primary" href="{{route('administrator.articles.add')}}">
        記事の追加
    </a>
</div>
            ...
            <div class="uk-accordion-content">        
                <form class="form-horizontal" method="GET">
                    <div class="uk-grid-small uk-flex-bottom" uk-grid>
                        <div class="uk-margin">
                            <label><input class="uk-checkbox" name="is_advertise" type="checkbox"/> 広告</label>
                            <label><input class="uk-checkbox" name="is_reprinted" type="checkbox"/> 転載記事</label>
                        </div>
                        ...
                        <div class="uk-width-1-2@s">
                            ...
                            <div class="uk-form-controls">
                                @include('component.input.writers', [ 'value' => isset($params['writer_id']) ? $params['writer_id']: null, "required" => false ])
                            </div>
                        </div>
                        <div class="uk-width-1-2@s">
