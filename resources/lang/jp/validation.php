...
return [
    ...
    */
    ...
    'email'                => ':attributeが正しい形式であるかを指定してください。',
    ...
    */
    ...
    'attributes' => [
        ...
        //記事関連
        "category_id" => "カテゴリ",
        "article_image_id" => "サムネイル画像",
        "writer_id" => "ライター",
        "title" => "タイトル",
        "summary" => "サマリー",
        "sentence" => "本文",
        "article_status_id" => "ステータス",
        "publish_date" => "公開日",
        "close_date" => "終了日",
        "on_top" => "トップ",
        "on_category_top" => "カテゴリトップ",
        //レビュー
        "comment" => "コメント",
        //ライター
        "pen_name" => "ペンネーム",
